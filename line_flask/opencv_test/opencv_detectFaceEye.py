...
#設定 haarcascades的路徑
#載入偵測人臉模組
face_cascade = cv2.CascadeClassifier('C:/Users/Big data/PycharmProjects/line_flask/harcascades/haarcascade_frontalface_default.xml')
#載入偵測眼睛模組
eye_cascade = cv2.CascadeClassifier('C:/Users/Big data/PycharmProjects/line_flask/harcascades/haarcascade_eye.xml')
